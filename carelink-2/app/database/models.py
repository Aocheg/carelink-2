...
from app.database.connection import Base, UTCDateTime
...
class MedicationAdministration(Timestamped, Base):
    ...
    administered_at: Mapped[datetime] = mapped_column(UTCDateTime())
...
class InvestigationItem(Timestamped, Base):
    ...
    available_at: Mapped[Optional[datetime]] = mapped_column(UTCDateTime())
...
class Discharge(Timestamped, Base):
    ...
    discharged_at: Mapped[datetime] = mapped_column(UTCDateTime())
